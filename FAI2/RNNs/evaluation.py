...
#     model_save_path = "C://Users//Sideeq Bello//CSC7809_FoundationModels//Project2//models//saved//transformer_model.pth"
#     tokenizer_model = "C:\\Users\\Sideeq Bello\\CSC7809_FoundationModels\\Project2\\data\\tokenizer.model"
#     batch_size = 128
#     device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

#     # Load test dataset
#     test_data = torch.load(os.path.join(processed_data_dir, "test_data.pkl"))
...
#     tokenizer.Load(tokenizer_model)
    ...
    # perplexity = compute_perplexity(transformer_model, test_loader, criterion, device)
    # print(f"Perplexity (PPL): {perplexity:.4f}")

    # # Compute BLEU Score
    # print("Computing BLEU Score...")
    # bleu_score = compute_bleu_score(transformer_model, test_loader, tokenizer, device)
